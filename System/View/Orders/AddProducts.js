      ...
      <View style={{ height:'100%',backgroundColor:'#fff' }}>
        ...
        <View style={{  paddingHorizontal:'5%',borderTopWidth:1 }}>
          <View style={{flexDirection:'row',paddingRight:'2%'}}>
            ...
            <Text style={Styles.LabelPrice}>₹ {"140.23"}</Text>
          </View>
          <View style={{flexDirection:'row',paddingRight:'2%'}}>
            <Text style={Styles.LabelTitle}>Discount</Text>
            <Text style={Styles.LabelPrice}>₹ {"10"}</Text>
          </View>
          <View style={{flexDirection:'row',paddingRight:'2%'}}>
            <Text style={Styles.LabelTitle}>Total</Text>
            <Text style={Styles.LabelPrice}>₹ {"130.23"}</Text>
          </View>
...
const Styles = StyleSheet.create({
  ...
  text:{ color:'#fff' },
  LabelTitle:{
    fontSize:15,color:'#000',flex:1,marginLeft:5
  },
